...
import { DeviceFunction, DeviceFunctionDef  } from '../models/device-functions';
...
export class OutletAccessory extends HubspaceAccessory {
 ...
 public initializeService(): void {
  ...
  private async getOn(): Promise<CharacteristicValue> {
    const func = getDeviceFunction(this.device.functions, DeviceFunction.OutletPower, undefined, this.outletIndex);
